...
const SectionOne = () => {
  return (
	<div className='flex items-center justify-center'>
		<div className='w-[1373px] sm:h-[800px] md:h-[700px] lg:h-[650px] relative'>
			<div className='grid grid-flow-row grid-rows-2 mg:grid-flow-cols lg:grid-flow-cols lg:grid-cols-2 sm:h-[750px] md:h-[700px] lg:h-[650px] bg-slate-600'>
